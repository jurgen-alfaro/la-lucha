...
function JuntaDirectivaTable() {
  const { members } = useContext(JuntaDirectivaContext);

  const data = useMemo(() => members, [members]);

  const columns = useMemo(
    () => [
      { Header: "", accessor: "idmember" },
      {
        Header: "Nombre",
        accessor: "name",
      },
...
export default JuntaDirectivaTable;
