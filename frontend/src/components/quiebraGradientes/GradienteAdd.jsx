...
function GradienteAdd() {
  const { addGradiente, getGradientes, isLoading, setIsLoading } = useContext(
    ...
    <div className='rounded-lg shadow-lg card bg-base-100'>
      <div className='card-body'>
        <h2 className='text-2xl my-4 font-bold card-title'>
          ...
          Agregar nuevo quiebra gradientes
        </h2>
          ...
          <form className='w-full max-w-lg' onSubmit={handleSubmit}>
            <div className='w-full px-3'>
              ...
              <input
                ...
                required
                name='name'
                placeholder='Nombre del quiebra gradientes'
            ...
            <div className='w-full px-3'>
              ...
              <input
                ...
                required
                name='location'
                placeholder='Ubicación del quiebra gradientes'
