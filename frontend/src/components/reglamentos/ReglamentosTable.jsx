...
function ReglamentosTable() {
  const { reglamentos } = useContext(ReglamentosContext);
  const data = useMemo(() => reglamentos, [reglamentos]);

  const columns = useMemo(
    () => [
      { Header: "", accessor: "idreglamento" },
      { Header: "Nombre", accessor: "rname" },
      {
        Header: "Descripción",
        accessor: "rdesc",
        Cell: ({ value }) => {
      ...
      { Header: "Documento", accessor: "rdoc" },
      {
...
export default ReglamentosTable;
