...
function SuggestionTable() {
  const { suggestions, setSuggestion } = useContext(SuggestionContext);

  const data = useMemo(() => suggestions, [suggestions]);
  const columns = useMemo(
    () => [
      { Header: "", accessor: "idsuggestions" },
      ...
      },
      {
        ...
        Cell: ({ value }) => {
          return value === 1 ? (
            ...
            <span className='badge badge-success'>Revisado</span>
          );
        },
      },
      {
