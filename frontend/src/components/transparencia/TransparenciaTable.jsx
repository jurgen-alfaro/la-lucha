...
function TransparenciaTable() {
  const { documentos } = useContext(TransparenciaContext);
  const data = useMemo(() => documentos, [documentos]);

  const columns = useMemo(
    () => [
      { Header: "", accessor: "iddoc" },
      { Header: "Nombre", accessor: "dname" },
      {
        Header: "Descripción",
        accessor: "ddesc",
        Cell: ({ value }) => {
      ...
      { Header: "Documento", accessor: "ddoc" },
      {
