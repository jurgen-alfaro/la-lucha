    ...
    >
      <section>
        ...
        <div className='container mx-auto'>
                ...
                <div className='card w-full bg-base-100 shadow-xl'>
                  <div className='card-body'>
                    ...
                    <p>
                      ...
                      relacionada a los estados financieros actuales de la
                      ASADA.
                    </p>
          ...
          <div className='grid  sm:justify-center lg:grid-cols-2 xl:grid-cols-3 gap-5 about-us-informes-list px-12'>
            {forms.length !== 0 &&
              forms.map((form) => {
                return (
                  <div
